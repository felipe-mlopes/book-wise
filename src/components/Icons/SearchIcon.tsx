    ...
    <span role="img" aria-label="search-icon">
      ...
      >
        ...
        <path 
          fillRule="evenodd" 
          clipRule="evenodd" 
          d="M13.2612 13.2612C13.5053 13.0171 13.901 13.0171 14.1451 13.2612L17.9419 17.0581C18.186 17.3021 18.186 17.6979 17.9419 17.9419C17.6979 18.186 17.3021 18.186 17.0581 17.9419L13.2612 14.1451C13.0171 13.901 13.0171 13.5053 13.2612 13.2612Z" 
          fill="#303F73"
        />
      </svg>
    </span>
