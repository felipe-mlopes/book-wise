...
export const metadata: Metadata = {
  title: 'Explore',
  description: 'Explore os livros do catalógo, escolha um e faça sua avaliação.'
}


export default function Explore() {
  return (
    <div className="flex flex-col gap-4 m-4 md:grid md:grid-rows-global md:gap-6 md:my-4 md:mx-4 lg:grid-cols-lg lg:mt-5 lg:mr-0 lg:mb-4 lg:ml-5 lg:gap-y-16 lg:gap-x-12 xl:gap-y-10 xl:gap-x-24">
      <aside
